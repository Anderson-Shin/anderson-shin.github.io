...
\$\frac{P}{L\_t}=P\_t+D\_t-P\_{t-1}\$

Where:

* \$P\_t\$: Asset price at time \$t\$
* \$D\_t\$: Cashflow (e.g., dividends)
* \$P\_{t-1}\$: Previous price
...
* Assumes \$D\_t\$ is reinvested and doesn’t earn its own return.
...
\$VaR(P/L)=-\mu\_{P/L}+\sigma\_{P/L}Z\_\alpha\$
\$VaR(L/P)=\mu\_{L/P}+\sigma\_{L/P}Z\_\alpha\$
...
$$
\alpha VaR=P_{t-1}\left(1-e^{\mu_R-\sigma_RZ_\alpha}\right)
$$
...
* \$n\$: sample size
* \$f(q)\$: density function at quantile \$q=VaR\_\alpha\$

---

## QQ Plot Interpretation

* Linear QQ plot → empirical data fits theoretical distribution
* Curved or steeper ends → heavy tails
* Useful for validating model fit and tail behavior
